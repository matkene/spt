...
class __Mustache_26ea7a1aab52749c8b0198bf2f5b3858 extends Mustache_Template
{
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section00fee8060f7e81a4166e13c4afcf0074($context, $indent, $value);
        }
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
...
';
    ...
    private function section00fee8060f7e81a4166e13c4afcf0074(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
