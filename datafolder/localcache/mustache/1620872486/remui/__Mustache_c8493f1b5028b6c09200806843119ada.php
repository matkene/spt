...
class __Mustache_c8493f1b5028b6c09200806843119ada extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section961ebe5e916506c197ca5b976aed59b1($context, $indent, $value);
...
';
            ...
            $buffer .= $this->sectionCc78d846e0e4e4f9f09d2a39e6518200($context, $indent, $value);
        }
    ...
    private function section961ebe5e916506c197ca5b976aed59b1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCc78d846e0e4e4f9f09d2a39e6518200(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
