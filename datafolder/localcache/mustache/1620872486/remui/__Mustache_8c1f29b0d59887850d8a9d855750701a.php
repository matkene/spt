...
class __Mustache_8c1f29b0d59887850d8a9d855750701a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE559736d3baddd7bf4d9fda7eac04ab6($context, $indent, $value);
        $buffer .= $indent . '</body>
';
        $buffer .= $indent . '</html>
';
    ...
    private function sectionE660a29108d74ce76f7514a1318a9fe7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE559736d3baddd7bf4d9fda7eac04ab6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionE660a29108d74ce76f7514a1318a9fe7($context, $indent, $value);
                $context->pop();
            }
        }
