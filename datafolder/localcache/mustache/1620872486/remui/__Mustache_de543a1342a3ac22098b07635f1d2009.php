...
class __Mustache_de543a1342a3ac22098b07635f1d2009 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAf4459bc3759198c5766e3b38a41a981($context, $indent, $value);
        $buffer .= $indent . '</div>
';
    ...
    private function sectionAcda1370f52af0695d6a2f7e7902902a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAf4459bc3759198c5766e3b38a41a981(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionAcda1370f52af0695d6a2f7e7902902a($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $context->pop();
            }
