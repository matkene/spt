...
class __Mustache_de5a014a26933b0f401a15344c78a929 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFff18c3a38ae85216e31564238230a92($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        ';
...
';
        ...
        $buffer .= $this->sectionCd60f64458e032043cd205837e21866b($context, $indent, $value);
...
';
    ...
    private function sectionFff18c3a38ae85216e31564238230a92(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section5f032377c6da2372c3c15bf90ed6125a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section5ee942a79d26e4a136f65389a315e33d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCe8762e790cae22444055a3aa5a4f6bc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9dc12745b34e38541d575c9ea614b618(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF02d5333746a2b3a9708d9e0a4c0dcd9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section20edc30c15020fbf10a72d4651d9e665(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section27ad038b10865a60fb4aa68e7de1a6ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section82bbf6591b78d2bead423393ea535e34(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCd60f64458e032043cd205837e21866b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5f032377c6da2372c3c15bf90ed6125a($context, $indent, $value);
                $buffer .= $indent . '                    </i>
';
...
';
                // 'unread_request_count' section
                $value = $context->find('unread_request_count');
                $buffer .= $this->section5ee942a79d26e4a136f65389a315e33d($context, $indent, $value);
                $buffer .= $indent . '                    </i>
';
                // 'hasblocks' section
                $value = $context->find('hasblocks');
                $buffer .= $this->sectionCe8762e790cae22444055a3aa5a4f6bc($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
...
';
                // 'hasblocks' section
                $value = $context->find('hasblocks');
                $buffer .= $this->section9dc12745b34e38541d575c9ea614b618($context, $indent, $value);
                $buffer .= $indent . '
';
                $buffer .= $indent . '                                ';
...
';
                ...
                $buffer .= $this->sectionF02d5333746a2b3a9708d9e0a4c0dcd9($context, $indent, $value);
                $buffer .= $indent . '                            </ul>
';
...
';
                // 'hasblocks' section
                $value = $context->find('hasblocks');
                $buffer .= $this->section20edc30c15020fbf10a72d4651d9e665($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'messagedrawer' section
                $value = $context->find('messagedrawer');
                $buffer .= $this->section27ad038b10865a60fb4aa68e7de1a6ea($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'usercanmanage' section
                $value = $context->find('usercanmanage');
                $buffer .= $this->section82bbf6591b78d2bead423393ea535e34($context, $indent, $value);
                $buffer .= $indent . '                            </div>
';
                $buffer .= $indent . '                        </div>
';
